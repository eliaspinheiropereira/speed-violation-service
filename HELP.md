...
* The original package name 'io.gitub.eliaspinheiropereira.speed-violation-service' is invalid and this project uses 'io.gitub.eliaspinheiropereira.speed_violation_service' instead.
